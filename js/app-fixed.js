    ...
    try {
        ...
        function processXmlContent(xmlContent) {
            try {
                ...
                console.log("XML parsed successfully:", traceData);
        ...
        function updateVulnerabilityBanner(vulnInfo) {
            ...
            document.getElementById('vulnerability-details').style.display = 'block';
        }
        ...
        function displayEventDetails(event, container) {
            ...
            // Add XML display for debugging
            let xmlHtml = '';
            if (event.originalXml) {
                xmlHtml = `
                    <div class="info-item">
                        <strong>Original XML:</strong>
                        <div class="xml-container">
                            <pre class="xml-content">${escapeHtml(event.originalXml)}</pre>
                        </div>
                    </div>
                `;
            }
